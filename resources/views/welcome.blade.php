...
<a class="w-full bg-secondary text-on-secondary h-14 rounded-lg font-label-md text-label-md text-[16px] flex items-center justify-center gap-sm hover:bg-secondary/90 transition-colors shadow-soft group" href="https://github.com/svan2511/khataflow/releases/download/v2.0.0/app.apk" target="_blank" rel="noopener noreferrer">
